...
var Popup = function (_ccui$RelativeBox) {
	...
	_createClass(Popup, [{
		...
		key: "playEntranceAnimation",
		value: function playEntranceAnimation() {
			this.setScale(0.0);
		...
		key: "playExitAnimation",
		value: function playExitAnimation(origin, exitFunction) {
			var scaleTo = new cc.ScaleTo(0.2, 0.0);
			var callFunc = new cc.callFunc(exitFunction, origin);
