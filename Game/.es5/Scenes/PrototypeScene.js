...
var PrototypeScene = function (_cc$Scene) {
	_inherits(PrototypeScene, _cc$Scene);

	function PrototypeScene() {
		_classCallCheck(this, PrototypeScene);

		return _possibleConstructorReturn(this, (PrototypeScene.__proto__ || Object.getPrototypeOf(PrototypeScene)).call(this));
	}

	_createClass(PrototypeScene, [{
		key: "onEnter",
